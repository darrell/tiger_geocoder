...
CREATE TABLE
       zip_lookup_all (
							 zip varchar(5), statefp VARCHAR(2), state VARCHAR(2), countyfp VARCHAR(3), county VARCHAR(100), cousubfp
							 VARCHAR(5), cousub VARCHAR(100), placefp VARCHAR(5), place VARCHAR(100), cnt INTEGER
       );
